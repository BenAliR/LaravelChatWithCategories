            ...
            <ul class="navbar-nav mr-auto">
                @auth
                    <li class="nav-item mx-2">
                        <a class="nav-link {{ (request()->is('posts*')) ? 'active' : '' }}" href="/posts" data-bs-toggle="tooltip" title="Voir les groupes"><i class="bi bi-people-fill"></i> Groupes</a>
                    </li>
                    <li class="nav-item mx-2">
                        <a class="nav-link {{ (request()->is('categories*')) ? 'active' : '' }}" href="/categories" data-bs-toggle="tooltip" title="Voir les catégories"><i class="bi bi-card-list"></i> Catégories</a>
                    </li>
                @endauth
            </ul>
